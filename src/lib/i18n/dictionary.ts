...
const es = {
  ...
  home: {
    ...
    brunchTitle: "Brunch los fines de semana",
    brunchMenuCta: "Ver nuestro menú",
  ...
  // Menú del café (los productos viven en src/lib/cafeMenu.ts)
  cafeMenu: {
    heroKicker: "KANm Café",
    heroTitlePre: "Nuestro",
    heroTitleScript: "menú",
    heroSubtitle:
      "Brunch, bebidas y postres hechos con amor. Ven a disfrutarlos a nuestro café en la Zona Colonial.",
    taxIncluded: "ITBIS incluido",
    jumpTo: "Secciones del menú",
    brunchBadge: "Solo fines de semana",
    categories: {
      brunch: { kicker: "para empezar el día", title: "Brunch" },
      bebidas: { kicker: "para acompañar", title: "Bebidas" },
      postres: { kicker: "el toque dulce", title: "Postres" },
    },
    groups: {
      picaderas: "Picaderas",
      sandwichBar: "Sandwich Bar",
      desayunos: "Desayunos / Brunch",
      jugos: "Jugos y Batidas",
      cafeFrio: "Café Frío y Bebidas Frías",
      cafeCaliente: "Café y Bebidas Calientes",
      tragos: "Tragos",
      latica: "La Latica",
      pedazos: "Pedazos",
    ...
    extraToppings: "Toppings adicionales",
    laticaLink: "Conoce La Latica",
    finalKicker: "te esperamos",
    finalTitle: "¿Se te antojó algo?",
    finalText: "Visítanos en la Zona Colonial o escríbenos por WhatsApp.",
...
const en: Dict = {
  ...
  home: {
    ...
    brunchTitle: "Brunch on weekends",
    brunchMenuCta: "See our menu",
  ...
  cafeMenu: {
    heroKicker: "KANm Café",
    heroTitlePre: "Our",
    heroTitleScript: "menu",
    heroSubtitle:
      "Brunch, drinks and desserts made with love. Come enjoy them at our café in the Colonial Zone.",
    taxIncluded: "Tax (ITBIS) included",
    jumpTo: "Menu sections",
    brunchBadge: "Weekends only",
    categories: {
      brunch: { kicker: "to start the day", title: "Brunch" },
      bebidas: { kicker: "to go along", title: "Drinks" },
      postres: { kicker: "the sweet touch", title: "Desserts" },
    },
    groups: {
      picaderas: "Bites",
      sandwichBar: "Sandwich Bar",
      desayunos: "Breakfast / Brunch",
      jugos: "Juices & Shakes",
      cafeFrio: "Iced Coffee & Cold Drinks",
      cafeCaliente: "Coffee & Hot Drinks",
      tragos: "Cocktails & Beer",
      latica: "La Latica",
      pedazos: "Slices",
      galletones: "Big Cookies",
    },
    eachPrice: "each",
    toppingsLabel: "Toppings",
    extraToppings: "Extra toppings",
    laticaLink: "Discover La Latica",
    finalKicker: "we're waiting for you",
    finalTitle: "Craving something?",
    finalText: "Visit us in the Colonial Zone or message us on WhatsApp.",
