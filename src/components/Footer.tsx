        ...
        <div>
          ...
          <div className="flex items-center gap-2.5 mt-5">
            <a
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center bg-card border border-[var(--border)] text-rose hover:text-white hover:bg-rose hover:border-rose hover:-translate-y-0.5 transition-all duration-200 shadow-sm"
            >
              <Instagram size={16} />
            </a>
            <a
