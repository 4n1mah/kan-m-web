...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-rose shadow-soft flex items-center justify-center text-white hover:opacity-90 transition"
    >
